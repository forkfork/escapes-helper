...
export const ignore = [/^\/blog.json$/, /^\/blog\/([^\/]+?).json$/, /^\/api\/offer-assist\/([^\/]+?)\/?$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/[date].svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:[date].svelte__"
	}
];
...
export const routes = (d => [
...

	{
		...
		pattern: /^\/([^\/]+?)\/?$/,
		parts: [
			{ i: 4, params: match => ({ date: d(match[1]) }) }
		]
	}
])(decodeURIComponent);

if (typeof window !== 'undefined') {
	import("/home/pi/git/escapes-helper/node_modules/sapper/sapper-dev-client.js").then(client => {
